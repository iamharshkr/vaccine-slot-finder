...
body {
	height: auto;
	filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#3885ec', endColorstr='#0059ce',GradientType=0 ); /* IE6-9 */
...
<body>
 <h1 class="text-center font-weight-bold"><a class="title" href="/vaccine-slot-finder">Covid Vaccine Slot Finder</a><sup>Beta</sup></h1>
 <span class="powered">Powered By Subhdeals</span>
 <div class="row">
 <div class="box">
<div class="form-check">
Find Slot Using City Name: <input class="form-check-input" type="radio" onclick="javascript:statepin();" name="yesno" id="yesCheck" checked><br> Find Slot Using Pincode : <input class="form-check-input" type="radio" onclick="javascript:statepin();" name="yesno" id="noCheck"><br>
</div>
<div id="searchState">
	<div class="form-group"> 
<label>Select State: </label>
<select class="form-control" name="state" id="state"><option value="default" data-tld="default">Select State</option ><option value="1" data-tld="1">Andaman and Nicobar Islands</option ><option value="2" data-tld="2">Andhra Pradesh</option ><option value="3" data-tld="3">Arunachal Pradesh</option ><option value="4" data-tld="4">Assam</option ><option value="5" data-tld="5">Bihar</option ><option value="6" data-tld="6">Chandigarh</option ><option value="7" data-tld="7">Chhattisgarh</option ><option value="8" data-tld="8">Dadra and Nagar Haveli</option ><option value="37" data-tld="37">Daman and Diu</option ><option value="9" data-tld="9">Delhi</option ><option value="10" data-tld="10">Goa</option ><option value="11" data-tld="11">Gujarat</option ><option value="12" data-tld="12">Haryana</option ><option value="13" data-tld="13">Himachal Pradesh</option ><option value="14" data-tld="14">Jammu and Kashmir</option ><option value="15" data-tld="15">Jharkhand</option ><option value="16" data-tld="16">Karnataka</option ><option value="17" data-tld="17">Kerala</option ><option value="18" data-tld="18">Ladakh</option ><option value="19" data-tld="19">Lakshadweep</option ><option value="20" data-tld="20">Madhya Pradesh</option ><option value="21" data-tld="21">Maharashtra</option ><option value="22" data-tld="22">Manipur</option ><option value="23" data-tld="23">Meghalaya</option ><option value="24" data-tld="24">Mizoram</option ><option value="25" data-tld="25">Nagaland</option ><option value="26" data-tld="26">Odisha</option ><option value="27" data-tld="27">Puducherry</option ><option value="28" data-tld="28">Punjab</option ><option value="29" data-tld="29">Rajasthan</option ><option value="30" data-tld="30">Sikkim</option ><option value="31" data-tld="31">Tamil Nadu</option ><option value="32" data-tld="32">Telangana</option ><option value="33" data-tld="33">Tripura</option ><option value="34" data-tld="34">Uttar Pradesh</option ><option value="35" data-tld="35">Uttarakhand</option ><option value="36" data-tld="36">West Bengal</option ></select>
<label>Select City: </label>
<select name="dist" id="dist" class="form-control" aria-invalid="false"><option selected="selected" value="">Select State First</option></select>
...
<input type="number" class="form-control" id="pincode" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" name="pincode" placeholder="Enter your Pincode. Eg: 110007" maxlength="6"></input>
	<label>Select Date: </label>
...
var $sort_select = $('#dist'),
    ...
    $('#state').change(function () {
      ...
      $.each(currentsort_mapping, function (value, name) {
        $sort_select.append(
          option_sort.clone().text(name).attr('value', value)
        );
      });
    });
  });
...
<div class="footer"><font color=#F99A2E>Made With <i class="fa fa-heart" style="color:red;"></i> By : Subhdeals</font>
	<div id="foot_c"><a href='https://subhdeals.com/'><font color=#F99A2E>&copy; Subhdeals</font></div></a>
</div>
</body>
</html>
